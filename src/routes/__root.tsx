  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocurrió un problema. Puedes recargar o volver al inicio.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Nemorphic" },
      {
        name: "description",
        content:
          "Nemorphic es un sello techno underground que impulsa artistas locales y emergentes con sesiones, lanzamientos y cultura sonora.",
      },
      { name: "author", content: "Nemorphic" },
